...
import static org.onimino.knet.KNetEventArgs.GAME_CURSOR;
import static org.onimino.knet.KNetEventArgs.GAME_ENDING;
import static org.onimino.knet.KNetEventArgs.GAME_EXCELLENT;
import static org.onimino.knet.KNetEventArgs.GAME_FIELD;
import static org.onimino.knet.KNetEventArgs.GAME_HOLD_PIECE;
...
import static org.onimino.knet.KNetEventArgs.GAME_RETRY;
...
import static org.onimino.knet.KNetEventArgs.REPLAY_DATA;
import static org.onimino.knet.KNetEventArgs.REPLAY_NOT_RECEIVED;
import static org.onimino.knet.KNetEventArgs.REPLAY_RECEIVED;
import static org.onimino.knet.KNetEventArgs.RESET_1P;
...
import org.onimino.gui.knet.KNetPanel;
import org.onimino.gui.knet.KNetPanelEvent;
import org.onimino.gui.knet.KNetPanelListener;
import org.onimino.knet.KNetClient;
import org.onimino.knet.KNetEvent;
import org.onimino.knet.KNetEventSource;
import org.onimino.knet.KNetGameClient;
...
import org.onimino.knet.obj.Replay;
...
public class AbstractNetMode extends AbstractMode implements KNetListener, KNetPanelListener {
	...
	protected int netNumSpectators() {
		if(channelInfo() == null)
			return 0;
		return channelInfo().getMembers().size() - channelInfo().getPlayers().size();
	}
